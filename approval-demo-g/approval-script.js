...
function continueText() {
    ...
    headerTextId.innerHTML = 'That\'s more like it! It\'s a close race<br />between the puppies, but one of them still wins. <span onclick="more1()" class="link">MORE</span>';
...
function more2() {
    ...
    headerTextId.innerHTML = 'The percentages are INDEPENDENT of one another.<br />Each shows the percentage of voters who<br />APPROVE of that candidate. <span onclick="more1()" class="link">BACK</span> | <span onclick="more3()" class="link">MORE</span>';
...
function more4() {
    ...
    headerTextId.innerHTML = 'These percentages show the number<br />of voters who approve of each possible<br />combination of candidates. <span onclick="more3()" class="link">BACK</span> | <span onclick="more5()" class="link">MORE</span>';
...
function more5() {
    ...
    headerTextId.innerHTML = 'The green highlighted row shows why there is such a<br />big change between the two vote results. <span onclick="more4()" class="link">BACK</span> | <span onclick="more6()" class="link">MORE</span>';
...
function more6() {
    ...
    headerTextId.innerHTML = 'Under Approval Voting,<br />all the voters who love puppies of all kinds<br />ARE FREE TO VOTE FOR THEM BOTH. <span onclick="more5()" class="link">BACK</span> | <span onclick="more7()" class="link">MORE</span>';
